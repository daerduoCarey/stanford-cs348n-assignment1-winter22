...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_suffix', type=str, help='exp suffix', default='vae')
    ...
    parser.add_argument('--probabilistic', action='store_false', default=True, help='probabilistic [default: False]')
    ...
    parser.add_argument('--kldiv_loss_weight', type=float, default=1e-1)
